...
async def run_smuggling_cycle(label, client):
    ...
    for i in range(6):
        ...
        if _has_button_containing(msg, "✅"):
            # صفحه انتخاب تعداد پیشی برای قاچاق (➖ ➕ ➕ / ✅ / BK) - همون تعداد
            # پیش‌فرض رو با ✅ تایید می‌کنیم تا به صفحه شروع قاچاق برسیم
            await _find_button_containing(msg, "✅").click()
