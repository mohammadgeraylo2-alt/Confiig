...
async def run_fishing_cycle(label, client):
    ...
    action_msg = await wait_step(
        client, group, lambda e: _has_button_containing(e, "پخیدن"),
    ...
    sell_msg = await wait_step(
        client, group, lambda e: _has_button_containing(e, "فروش"),
