...
async def complete_login(client, label, me, group=None, message=None, min_delay=None, max_delay=None):
...
async def finish_login(update, context):
    ...
    if requester_id == ADMIN_ID:
        await complete_login(client, label, me, group, message, min_delay, max_delay)
